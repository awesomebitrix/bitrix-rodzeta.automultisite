...
- Подготовить домены и папки сайтов по типовой схеме (отдельная папка для каждого домена, привязать папку к своему рабочему домену, создать символьные ссылки на bitrix и upload)
